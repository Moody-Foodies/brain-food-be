...
RSpec.describe FavoriteRecipesService do
  describe '#create_recipe' do
    ...
    let(:response_body) do
      {
        message: "Favorite recipe created successfully",
    ...
    context 'when successful' do
      it 'returns the response message' do
        service = FavoriteRecipesService.new
        response = service.create_recipe(recipe_details)
